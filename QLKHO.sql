...
go
alter table Nhap add CONSTRAINT fk_ton_nhap Foreign key (MaVT) REFERENCES Ton(MaVT)

alter table Xuat add CONSTRAINT fk_ton_xuat Foreign key (MaVT) REFERENCES Ton(MaVT)
go

Insert into Ton Values ('VT01','Bánh Choco pie',110)
Insert into Ton Values('VT02','Kẹo mạch nha',50)
Insert into Ton Values('VT03','Bánh mì ngọt',200)
Insert into Ton Values('VT04','Nước ngọt có gas',200)
Insert into Ton Values('VT05','Kẹo dừa',200)
Insert into Nhap Values (101,'VT01',210,50000,'1/6/2022')
Insert into Nhap Values(102,'VT02',100,20000,'1/6/2022')
Insert into Nhap Values(103,'VT03',80,35000,'2/6/2022')
Insert into Xuat Values (10001,'VT02',50,23000,'5/6/2022')
Insert into Xuat Values(10002,'VT01',100,56000,'7/6/2022')
